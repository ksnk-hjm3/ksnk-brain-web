...
# --- [DB設定：Status 1を回避する安全設計] ---
# ※ RenderのDashboard > PostgreSQL > Database 欄の正確な名前に書き換えてください
...
<head>
    ...
    <style>
        ...
        /* 🌳 【聖域】image0(1).jpeg を1pxの狂いなく再現したSVG背景 */
        .art-bg {
        ...
        /* 🔍 検索窓：スマホ枠に完全フィット */
        .search-pill { background: white; border-radius: 999px; box-shadow: 0 10px 40px rgba(0,0,0,0.06); border: 1px solid #e2e8f0; width: 100%; box-sizing: border-box; }
        ...
        .logo-text { white-space: nowrap; font-size: 1.875rem; font-weight: 900; font-style: italic; letter-spacing: -0.05em; }
    </style>
</head>
<body class="min-h-screen flex flex-col items-center text-center">
    ...
    <div class="art-bg">
        <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M38 12C38 9 40 7 43 7H57C60 7 62 9 62 12V38H88C91 38 93 40 93 43V57C93 60 91 62 88 62H62V88C62 91 60 93 57 93H43C40 93 38 91 38 88V62H12C9 62 7 60 7 57V43C7 40 9 38 12 38H38V12Z" fill="#A3C9D6" fill-opacity="0.9"/>
    ...
    <main class="flex-grow w-full px-5 flex flex-col items-center">
        ...
        <section class="w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-6 mb-32 text-left">
            ...
            <div class="bg-white p-10 rounded-[40px] border border-slate-50 shadow-sm space-y-4">
                ...
                <div>
                    ...
                    <p class="text-[13px] text-slate-500 leading-relaxed">発行年、ジャーナル、言語で素早く目的の論文へ。他職種の知見を統合した解析を行います。</p>
                </div>
            </div>
            <div class="bg-white p-10 rounded-[40px] border border-slate-50 shadow-sm space-y-4">
                ...
                <div>
                    ...
                    <p class="text-[13px] text-slate-500 leading-relaxed">要約、引用数、関連論文を一覧で確認。PubMedへ直接リンクし、臨床での確信を支援します。</p>
                </div>
            </div>
        </section>
    </main>
